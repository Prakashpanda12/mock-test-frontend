                    ...
                    <div className="p-5 md:p-6 flex-1">
                      ...
                      <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-gray-600 mb-5">
                        ...
                        {(() => {
                          ...
                          if (bookmarkCount > 0) {
                            return (
                              <div className="flex items-center gap-1.5 text-yellow-600 font-semibold bg-yellow-50 px-2 py-0.5 rounded-md border border-yellow-200">
                                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" /></svg>
                                <span>{bookmarkCount} Important</span>
                              </div>
                            );
                          }
                          return null;
